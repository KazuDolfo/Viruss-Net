...
const CATEGORIES = [
  ...
  { id: 'wildcard', name: 'Comodín', type: 'organ', color: 'multicolor' },
  ...
  { id: 'virus_wildcard', name: 'Virus Comodín', type: 'virus', color: 'multicolor' },
  ...
  { id: 'sp_transplant', name: 'Trasplante', type: 'treatment', color: 'multicolor' },
  ...
  { id: 'sp_glove', name: 'Guante de Látex', type: 'treatment', color: 'multicolor' },
] as const;
